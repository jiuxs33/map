...
(function (global, factory) {
    ...
    Observable.prototype.un = function (event) {
        ...
        if (type === 'string') {
            ...
            eventName = event[0];
            key = event[1];
            if (Observable.hasOwnKey(this.Events, eventName) && Observable.hasOwnKey(this.Events[
                    eventName], key)) {
    ...
    var getCurvePoints = function getCurvePoints(t, controlPoints) {
        ...
        for (var _i = 0; _i < controlPoints.length - 1; _i++) {
            ...
            for (var _t = 0; _t < FITTING_COUNT; _t++) {
                var pnt = getCubicValue(_t / FITTING_COUNT, pnt1, normals[_i * 2], normals[_i * 2 + 1],
                    pnt2);
                points.push(pnt);
            }
            points.push(pnt2);
        ...
        (function (global, factory) {
            ...
            function assign(ta) {
                ...
                function update() {
                    ...
                    var actualHeight = computed.boxSizing === 'content-box' ? Math.round(
                        parseFloat(computed.height)) : ta.offsetHeight;
                    ...
                    if (actualHeight !== styleHeight) {
                        if (computed.overflowY === 'hidden') {
                            ...
                            resize();
                            actualHeight = computed.boxSizing === 'content-box' ? Math.round(
                                parseFloat(window.getComputedStyle(ta, null).height)) : ta.offsetHeight;
                        }
                    } else {
    ...
    var PlotTextBox = function (_ol$Overlay) {
        ...
        function PlotTextBox() {
            ...
            var _ref = [options['id'], options['element'], options['offset'], options['stopEvent'],
                    options['positioning'], options['insertFirst'], options['autoPan'], options[
                        'autoPanAnimation'], options['autoPanMargin'], options['className'] ? options[
                        'className'] : 'ol-plot-text-editor'],
                id = _ref[0],
                element = _ref[1],
                offset = _ref[2],
                stopEvent = _ref[3],
            ...
            _this._position = options['position'] && options['position'].length > 0 ? options[
                'position'] : [];
            ...
            if (points < 2) {
                ...
                for (var _i = 0; _i < pnts.length - 2; _i++) {
                    ...
                    for (var t = 0; t <= FITTING_COUNT; t++) {
                        var pnt = getCubicValue(t / FITTING_COUNT, pnt1, normals[_i * 2], normals[
                            _i * 2 + 1], pnt2);
                        pList.push(pnt);
                    }
                    pList.push(pnt2);
    ...
    var AttackArrow = function (_ol$geom$Polygon) {
        ...
        AttackArrow.prototype.generate = function generate() {
            try {
                ...
                if (points < 2) {
                    ...
                    var tailWidthFactor = MathDistance(tailLeft, tailRight) / getBaseLength(
                        bonePnts);
                    var bodyPnts = this.getArrowBodyPoints(bonePnts, neckLeft, neckRight,
                        tailWidthFactor);
        ...
        AttackArrow.prototype.getArrowPoints = function getArrowPoints(pnt1, pnt2, pnt3, clockWise) {
            ...
            if (arrowPnts && Array.isArray(arrowPnts) && arrowPnts.length > 0) {
                ...
                var bodyPnts = this.getArrowBodyPoints(points, neckLeftPoint, neckRightPoint,
                    tailWidthFactor);
                if (bodyPnts) {
        ...
        AttackArrow.prototype.getArrowHeadPoints = function getArrowHeadPoints(points, tailLeft,
            tailRight) {
            try {
                ...
                var headEndPnt = getThirdPoint(points[points.length - 2], headPnt, 0, headHeight,
                    true);
                var neckEndPnt = getThirdPoint(points[points.length - 2], headPnt, 0, neckHeight,
                    true);
        ...
        AttackArrow.prototype.getArrowBodyPoints = function getArrowBodyPoints(points, neckLeft,
    ...
    var DoubleArrow = function (_ol$geom$Polygon) {
        ...
        DoubleArrow.prototype.generate = function generate() {
            try {
                ...
                if (count > 2) {
                    ...
                    if (isClockWise(pnt1, pnt2, pnt3)) {
                        leftArrowPnts = this.getArrowPoints(pnt1, this.connPoint, this.tempPoint4,
                            false);
                        ...
                        rightArrowPnts = this.getArrowPoints(this.connPoint, pnt1, this.tempPoint4,
                            true);
                    }
        ...
        DoubleArrow.prototype.getArrowBodyPoints = function getArrowBodyPoints(points, neckLeft,
            neckRight, tailWidthFactor) {
            var allLen = wholeDistance(points);
            var len = getBaseLength(points);
            var tailWidth = len * tailWidthFactor;
        ...
        FineArrow.prototype.generate = function generate() {
            try {
                ...
                if (cont < 2) {
                    ...
                    var pList = [tailLeft, neckLeft, headLeft, pnt2, headRight, neckRight,
                        tailRight];
                    this.setCoordinates([pList]);
                }
            } catch (e) {
    ...
    var AssaultDirection = function (_FineArrow) {
        ...
        function AssaultDirection(coordinates, points, params) {
            ...
            var _this = possibleConstructorReturn(this, _FineArrow.call(this, coordinates, points,
                params));
    ...
    var TailedAttackArrow = function (_AttackArrow) {
        ...
        function TailedAttackArrow(coordinates, points, params) {
            ...
            var _this = possibleConstructorReturn(this, _AttackArrow.call(this, coordinates, points,
                params));
        ...
        TailedAttackArrow.prototype.generate = function generate() {
            try {
                ...
                if (points < 2) {
                    ...
                    leftPnts = getQBSplinePoints(leftPnts);
                    rightPnts = getQBSplinePoints(rightPnts);
                    this.setCoordinates([leftPnts.concat(headPnts, rightPnts.reverse(), [this.swallowTailPnt,
                        leftPnts[0]])]);
                }
            } catch (e) {
                console.log(e);
        ...
        TailedSquadCombat.prototype.generate = function generate() {
            try {
                ...
                if (count < 2) {
                    ...
                    leftPnts = getQBSplinePoints(leftPnts);
                    rightPnts = getQBSplinePoints(rightPnts);
                    this.setCoordinates([leftPnts.concat(headPnts, rightPnts.reverse(), [tailPnts[1],
                        leftPnts[0]])]);
                }
            } catch (e) {
                console.log(e);
        ...
        GatheringPlace.prototype.generate = function generate() {
            ...
            if (pnts.length < 2) {
                ...
                for (var _i = 0; _i < pnts.length - 2; _i++) {
                    ...
                    pList.push(pnt1);
                    for (var t = 0; t <= FITTING_COUNT; t++) {
                        var _pnt = getCubicValue(t / FITTING_COUNT, pnt1, normals[_i * 2], normals[
                            _i * 2 + 1], pnt2);
                        pList.push(_pnt);
                    }
                    pList.push(pnt2);
    ...
    var CurveFlag = function (_ol$geom$Polygon) {
        ...
        CurveFlag.prototype.calculatePonits = function calculatePonits(points) {
            ...
            if (points.length > 1) {
                ...
                var point2 = [(endPoint[0] - startPoint[0]) / 4 + startPoint[0], (endPoint[1] -
                    startPoint[1]) / 8 + startPoint[1]];

                var point3 = [(startPoint[0] + endPoint[0]) / 2, startPoint[1]];

                var point4 = [(endPoint[0] - startPoint[0]) * 3 / 4 + startPoint[0], -(endPoint[1] -
                    startPoint[1]) / 8 + startPoint[1]];
                ...
                var point7 = [(endPoint[0] - startPoint[0]) * 3 / 4 + startPoint[0], (endPoint[1] -
                    startPoint[1]) * 3 / 8 + startPoint[1]];

                var point8 = [(startPoint[0] + endPoint[0]) / 2, (startPoint[1] + endPoint[1]) / 2];

                var point9 = [(endPoint[0] - startPoint[0]) / 4 + startPoint[0], (endPoint[1] -
                    startPoint[1]) * 5 / 8 + startPoint[1]];
    ...
    var PlotDraw = function (_Observable) {
        ...
        function PlotDraw(map, params) {
            ...
            _this.layerName = _this.options && _this.options['layerName'] ? _this.options['layerName'] :
                BASE_LAYERNAME;
        ...
        PlotDraw.prototype.textAreaDrawEnd = function textAreaDrawEnd(event) {
            if (event && event.feature) {
                ...
                var _ref = [Math.abs(topLeft[0] - bottomRight[0]), Math.abs(topLeft[1] -
                        bottomRight[1])],
                    _width = _ref[0],
                    _height = _ref[1];
        ...
        PlotDraw.prototype.activateMapTools = function activateMapTools() {
            if (this.dblClickZoomInteraction && this.dblClickZoomInteraction instanceof ol.interaction
                .DoubleClickZoom) {
    ...
    var PlotEdit = function (_Observable) {
        ...
        PlotEdit.prototype.destroyHelperDom = function destroyHelperDom() {
            ...
            if (this.controlPoints && Array.isArray(this.controlPoints) && this.controlPoints.length >
                0) {
                this.controlPoints.forEach(function (item, index) {
                    ...
                    if (element) {
                        off(element, 'mousedown', _this3.controlPointMouseDownHandler.bind(
                            _this3));
                        off(element, 'mousemove', _this3.controlPointMouseMoveHandler2.bind(
                            _this3));
                    }
                });
                this.controlPoints = [];
        ...
        PlotEdit.prototype.initControlPoints = function initControlPoints() {
            ...
            var cPnts = this.getControlPoints();
            if (cPnts && Array.isArray(cPnts) && cPnts.length > 0) {
                if (cPnts.length > this.options['limitControlPoints'] && this.options.hasOwnProperty(
                        'limitControlPoints') && this.options['limitControlPoints'] > 2) {
                    var _n = Math.floor(cPnts.length / (this.options['limitControlPoints'] - 2)) ||
                        1;
        ...
        PlotEdit.prototype.activate = function activate(plot) {
            ...
            if (plot && plot instanceof ol.Feature && plot.get('isPlot') && plot.getGeometry().isPlot &&
        ...
        PlotEdit.prototype.plotMouseMoveHandler = function plotMouseMoveHandler(event) {
            ...
            if (this.ghostControlPoints && Array.isArray(this.ghostControlPoints) && this.ghostControlPoints
                .length > 0) {
                for (var i = 0; i < this.ghostControlPoints.length; i++) {
                    var coordinate = [this.ghostControlPoints[i][0] + deltaX, this.ghostControlPoints[
                        i][1] + deltaY];
    ...
    var StyleFactory = function StyleFactory(options) {
        var option = options && (typeof options === 'undefined' ? 'undefined' : _typeof(options)) ===
            'object' ? options : {};
    ...
    StyleFactory.prototype._getRegularShape = function (options) {
        try {
            var regularShape = new ol.style.RegularShape({
                ...
                snapToPixel: typeof options['snapToPixel'] === 'boolean' ? options[
                    'snapToPixel'] : true,
                stroke: this._getStroke(options['stroke']) || undefined,
                rotation: typeof options['rotation'] === 'number' ? options['rotation'] : 0,
                rotateWithView: typeof options['rotateWithView'] === 'boolean' ? options[
    ...
    StyleFactory.prototype._getIcon = function (options) {
        try {
            ...
            var icon = new ol.style.Icon({
                ...
                offset: options['offset'] && Array.isArray(options['offset']) && options[
                    'offset'].length === 2 ? options['offset'] : [0, 0],
                ...
                rotateWithView: typeof options['rotateWithView'] === 'boolean' ? options[
                    'rotateWithView'] : false,
                opacity: typeof options['imageOpacity'] === 'number' ? options['imageOpacity'] :
                    1,
                rotation: typeof options['imageRotation'] === 'number' ? options[
                    'imageRotation'] : 0,
                size: options['size'] && Array.isArray(options['size']) && options['size'].length ===
                    2 ? options['size'] : undefined,
                imgSize: options['imgSize'] && Array.isArray(options['imgSize']) && options[
                    'imgSize'].length === 2 ? options['imgSize'] : undefined,
    ...
    StyleFactory.prototype._getStroke = function (options) {
        try {
            ...
            var stroke = new ol.style.Stroke({
                ...
                lineCap: options['strokeLineCap'] && typeof options['strokeLineCap'] ===
                    'string' ? options['strokeLineCap'] : 'round',
                lineJoin: options['strokeLineJoin'] && typeof options['strokeLineJoin'] ===
                    'string' ? options['strokeLineJoin'] : 'round',
                lineDash: options['strokeLineDash'] ? options['strokeLineDash'] : undefined,
                lineDashOffset: typeof options['strokeLineDashOffset'] === 'number' ? options[
                    'strokeLineDashOffset'] : '0',
                miterLimit: typeof options['strokeMiterLimit'] === 'number' ? options[
                    'strokeMiterLimit'] : 10,
    ...
    StyleFactory.prototype._getText = function (options) {
        try {
            var text = new ol.style.Text({
                font: options['textFont'] && typeof options['textFont'] === 'string' ? options[
                ...
                rotation: typeof options['textRotation'] === 'number' ? options['textRotation'] :
                    0,
                text: options['text'] && typeof options['text'] === 'string' ? options['text'] :
                    undefined,
                textAlign: options['textAlign'] && typeof options['textAlign'] === 'string' ?
                    options['textAlign'] : 'start',
                textBaseline: options['textBaseline'] && typeof options['textBaseline'] ===
                    'string' ? options['textBaseline'] : 'alphabetic',
                rotateWithView: typeof options['rotateWithView'] === 'boolean' ? options[
                    'rotateWithView'] : false,
    ...
    var PlotUtils = function () {
        function PlotUtils(map, options) {
            ...
            this.layerName = this.options && this.options['layerName'] ? this.options['layerName'] :
                BASE_LAYERNAME;
        }
                    ...
                    if (style && style instanceof ol.style.Style) {
                        ...
                        if (fill && fill['fillColor']) {
                            ...
                            if (rgbaArray && typeof opacity === 'number') {
                                backgroundColor = this.handleBackgroundColor(ol.color.asString(
                                    rgbaArray), opacity);
                            }
                        }
                ...
                if (layer) {
                    ...
                    if (source && source instanceof ol.source.Vector) {
                        ...
                        features.forEach(function (feature) {
                            if (feature && feature['geometry'] && feature['geometry'][
                                    'type'] !== 'PlotText') {
                                if (feature['properties']['type'] && Geometry[feature[
                                        'properties']['type']]) {
                                    var feat = new ol.Feature({
                                        geometry: new Geometry[feature['properties']
                                            ['type']]([], feature['properties']
                                            ['points'], feature['properties'])
                                    });
                                    feat.set('isPlot', true);
                                    _extents.push(feat.getGeometry().getExtent());
                                    if (feature['properties']['style']) {
                                        var style_ = new StyleFactory(feature['properties']
                                            ['style']);
                                        if (style_) {
                            ...
                            } else if (feature && feature['geometry'] && feature['geometry']
                                ['type'] === 'PlotText') {
                                _extents.push(new ol.geom.Point(feature.geometry[
                                    'coordinates']).getExtent());
                                var _plotText = new PlotTextBox({
        ...
        PlotUtils.prototype._getExtent = function _getExtent(extents) {
            ...
            var bbox = [Number.POSITIVE_INFINITY, Number.POSITIVE_INFINITY, Number.NEGATIVE_INFINITY,
                Number.NEGATIVE_INFINITY];
            var _extent = extents.reduce(function (prev, coord) {
                return [Math.min(coord[0], prev[0]), Math.min(coord[1], prev[1]), Math.max(
                    coord[2], prev[2]), Math.max(coord[3], prev[3])];
            }, bbox);
